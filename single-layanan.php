 ...
 */
  ...
  while(have_posts()) {
    ...
    $deskripsi_layanan = (has_excerpt() ? get_the_excerpt() : '');
...
?>
  ...
  <main id="rscMain" class="rsc-bg-white rsc-pb-16 sm:rsc-pb-[162px] md:rsc-pb-[250px] lg:rsc-pb-[260px]">
    <!-- Hero -->
    <section class="rsc-layanan-hero" style="background-image: url('<?php echo esc_url($gambar_layanan); ?>');">
      ...
      <div class="rsc-custom-container">
        <div class="rsc-relative rsc-z-20 rsc-space-y-8 rsc-max-w-none sm:rsc-max-w-lg lg:rsc-max-w-xl rsc-px-4 rsc-py-16 rsc-mx-auto">
          <div class="rsc-space-y-4">
            <h1 class="rsc-title"><?php echo esc_html($judul_layanan); ?></h1>
                ...
                <div>
                  <nav class="rsc-widget-share-to-socmed">
                    <ul>
                      ...
                      <li>
                        <a href="<?php echo esc_url('https://www.facebook.com/sharer.php?u=' . $tautan_layanan); ?>" title="<?php echo __('Facebook', 'rsc'); ?>" target="_blank">
                          <i class="fa-brands fa-facebook fa-lg rsc-text-[#4267B2]"></i>
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo esc_url('https://twitter.com/intent/tweet?text=' . $judul_layanan . '&url=' . $tautan_layanan); ?>" title="<?php echo __('Twitter', 'rsc'); ?>" target="_blank">
                          <i class="fa-brands fa-twitter fa-lg rsc-text-[#1DA1F2]"></i>
                        </a>
                      </li>
                      <li>
                        <a href="<?php echo esc_url('https://api.whatsapp.com/send?phone=&text=' . $judul_layanan . '%20-%20' . $tautan_layanan); ?>" title="<?php echo __('WhatsApp', 'rsc'); ?>" target="_blank">
                          <i class="fa-brands fa-whatsapp fa-lg rsc-text-[#25D366]"></i>
                        </a>
                      </li>
                      <li class="rsc-relative">
                        <a href="<?php echo esc_url($tautan_layanan); ?>" title="<?php echo __('Salin tautan', 'rsc'); ?>" class="rsc-copy-url">
